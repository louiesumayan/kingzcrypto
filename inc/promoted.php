      ...
      <div class="scrollable">
         ...
         <table class="table is-fullwidth" attr-table="promoted">
            ...
            <tbody>
               ...
               <?php
               $sql = "SELECT * FROM coins Where status = 'approve' ";
                  ...
                  foreach($res as $index => $row){
                     ...
                     $cap_network =  strtoupper($row['cap_network']);
                        if($presale == ' YES'){
                           ...
                           $presale = "-";
                           if($cap_network != ''){
                              $softcap  = "<div class='column-title'>Softcap</div><div>0 $cap_network</div>";
                           }else{
                              $softcap  = '-';
                           }
                     ...
                     if(checkIfVotedByCoin($id, $_SESSION['id']) != true){
                       
                        $voteright = "<a href='/dashboard/?tk=$tk&cid=$id' class='button is-primary'>
                                    Vote
                                    </a>";
                     }else{
                        $voteright = '';
                     ...
                     echo "<tr data-listingid='47851'>
                              <td class='sticky-col display-mobile'>
                                 <a href='/dashboard/coin.php?cid=$id'>
                                    <div>
                                       <div class='flex'>
                                          <div class='index'>
                                             $index                
                              ...
                              <td class='display-mobile ignore'>
                                 <div class='votes-col'>
                                    ...
                                    <div class='has-buttons'>
                                       <button class='button is-secondary promoted-boost-btn' data-name='$name' data-imageurl='$photo' data-id='47851'>
                                       Boost
                                       </button>
                                       $voteright
                                    </div>
                              ...
                              <td class='display-desktop'>
                                    ...
                                    <div class='has-boosts'>
                                       <img src='/assets/img/boost.png' alt=''> <span class='tag boosts'>x$boosts</span>
                                    </div>
                                
                              </td>
                              <td class='display-desktop ignore'>
                                 <a href='/dashboard/cointboots.php?cid=$id' class='button is-secondary promoted-boost-btn'>
                                 Boost
                                 </a>
                                 $voteright
                              </td>
