...
if ($_SERVER["REQUEST_METHOD"] == "GET") {
   if(isset($_GET['tk']) && isset($_GET['cid']) && isset($_GET['status']) && isset($_GET['apd'])){
            ...
            <tbody>
               ...
               if(!empty($res)){
                  foreach($res as $index => $row){
                     ...
                     $actions = " $acceptbtn
                                 <a href='/dashboard/coins.php?apd=true&status=false&cid=$id&tk=$token' class='button is-danger'>
                                    Delete
                                 </a>";
                     echo "<tr data-listingid='47851'>
                              ...
                              <td class='display-desktop'>
                                 ...
                                 <i class='fas fa-shield-alt'></i> $sts
                                 </span>
                              </td>
