        ...
        if($_GET['tk'] == $_SESSION['_token']){
            ...
            if(isset($sql)){
                ...
                if(executeQueryV2($sql, $mysqli)){
                    header('Location: /boots_payment.php');
                    exit();
                }
            }
        }  
        ...
        <div class="container containerless">
            <div class="scrollable">
                ...
                <table class="table is-fullwidth">
                    ...
                    <tbody>
                    <?php
                    $sql0 = "SELECT * FROM buy_boosts WHERE userid = '$ulid' AND status IS NULL";
                            ...
                            echo " <tr>
                                    ...
                                    <td>
                                        <div class='has-buttons'>
                                            <a class='button is-danger cancel' href='/boots_payment.php?cancel=$id&tk=$tk'>Cancel</a>
                                            <a class='button is-primary' href='/boosts/e0be5177/pay'>PAY</a>
                                        </div>
                                    </td>
                                </tr>";
                        }
        ...
        <div class="container containerless">
            <div class="scrollable">
                ...
                <table class="table is-fullwidth">
                    ...
                    <tbody>
                    <?php
                    $sql0 = "SELECT * FROM buy_boosts WHERE status = 'complete'";
                    $res0 = executeQueryV2($sql0, $mysqli);
                    if(!empty($res0)){
                        //print_r($res0);
                        foreach($res0 as $a => $row){
        ...
        <div class="container containerless">
            <div class="scrollable">
                ...
                <table class="table is-fullwidth">
                    ...
                    <tbody>
                    <?php
                    $sql0 = "SELECT * FROM buy_boosts WHERE status = 'cancel'";
                    $res0 = executeQueryV2($sql0, $mysqli);
                    if(!empty($res0)){
                        //print_r($res0);
                        foreach($res0 as $a => $row){
